...
За секој автор се чува име, презиме, биографија и ниво на искуство (Почетник, Професионалец, Етаблиран автор). Сите модели треба да се регистрираат во админ панелот.

При додавање на нова книга, полето за корисник не треба да се пополнува рачно, туку системот автоматски да го зачува корисникот кој е во моментот најавен во системот.
